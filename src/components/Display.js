...
const Display = () => {
  ...
  return (
    <>
      ...
      <div className="all d-flex justify-content-evenly ">
        <div className="lpart d-none d-sm-block rounded bg-dark bg-opacity-80 text-light mx-2 my-2 ">
          <div className="mx-4 my-4 py-3 ">
            ...
            <p className="text-justify  py-2 px-2 bg-info bg-opacity-10 rounded ms-2 ">
              This web app is Developed by Nirbhay he is a full stack dewloper .
              the web app use for real time weather information if the user
              search any city then tha app give the result for the same city
            </p>
          </div>
        </div>
        ...
        <div className="rpart rounded shadow-lg m-2 ">
          <div className="p-3">
            ...
            {code === 200 ? (
              <>
                <div>
                  <h2 className="text-center text-capitalize text-warning mt-3">
                    <i
                ...
                <div className="d-flex mt-4 justify-content-evenly">
                  <h3>
                    ...
                    <heading> {data.temp} &deg;C </heading>
                  </h3>
                  <h3>{wtype}</h3>
                </div>
                <Wicon para={wtype} />
              ...
              <h4 className="text-center text-capitalize text-info mt-3">
